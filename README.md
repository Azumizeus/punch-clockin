...
**EN — judges, start here:** open [`docs/GUIDE-JURY.md`](docs/GUIDE-JURY.md) (English first) for a step-by-step test of the app, and [`docs/PITCH-JURY.md`](docs/PITCH-JURY.md) for the pitch. Every money-related action in the app is a **real signed devnet transaction** — nothing is simulated. Signed APK: [GitHub Release v1.6.6](https://github.com/Azumizeus/punch-clockin/releases/latest) — `punch-clockin-seeker-v1.6.6.apk` (arm64, identité Seeker Premium, RPC personnalisé + test de connexion).
